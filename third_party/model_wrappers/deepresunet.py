#source: https://github.com/galprz/brain-tumor-segmentation/
import torch
...
class DeepResUNet(nn.Module):
    def __init__(self, in_channels=212, out_classes=3):
        super(DeepResUNet, self).__init__()

        self.in_channels = in_channels

        self.down_conv1 = PreActivateResBlock(self.in_channels, 64)
